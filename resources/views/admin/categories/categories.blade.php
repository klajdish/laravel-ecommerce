                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.category.update', $category->id)}}" class="btn btn-ghost btn-icon btn-sm rounded-circle texttooltip" data-template="editOne">
                                            ...
                                            <a href="{{route('admin.category.delete',['category_id' => $category->id ] )}}"  onclick="return confirm('Are you sure you want to delete this item')" class="btn btn-ghost btn-icon btn-sm rounded-circle texttooltip" data-template="trashOne">
