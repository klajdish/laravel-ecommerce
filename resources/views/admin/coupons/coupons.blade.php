                ...
                <div class="card-header">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 mb-3 text-end">
                            <a href="{{route('admin.coupon.add')}}" class="btn btn-primary me-2">+ Add Coupon</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table text-nowrap mb-0 table-centered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.coupon.update', $coupon->id)}}" class="btn btn-ghost btn-icon btn-sm rounded-circle texttooltip" data-template="editOne">
                                        ...
                                        <a href="{{route('admin.coupon.delete', ['coupon_id' => $coupon->id])}}" onclick="return confirm('Are you sure you want to delete this item')" class="btn btn-ghost btn-icon btn-sm rounded-circle texttooltip" data-template="trashOne">
